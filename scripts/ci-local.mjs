...
// Nothing to derive: this repo hardcodes its base path in vite.config.ts, prerender.mjs and
// serve-dist.mjs, deliberately, so there is no env var for the pipeline to disagree about.
