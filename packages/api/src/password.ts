 ...
 * ADMIN_PASSWORD, which is the quickest way to get a local placeholder running — the hash
 * can be adopted whenever it suits, with no change to the password itself.
 *
