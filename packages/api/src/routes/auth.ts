...
// Two layers. The Firestore (or dev-store) record survives restarts; this one catches a
// burst inside a single process without a round trip per attempt, and is the only limit
// left if the store is unreachable.
